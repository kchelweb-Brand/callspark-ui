...
function AdminLoginPage() {
  ...
  const [email, setEmail] = useState("owner@kchel.app");
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-sidebar px-5 py-12">
      ...
      >
        ...
        <p className="mt-1 text-sm text-sidebar-foreground/70">
          Restricted to platform owners. This is not the tenant workspace login.
        </p>
        ...
        <div className="mt-7 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="admin-password" className="text-sidebar-foreground/80">
              Password
            </Label>
            <Input
              id="admin-password"
